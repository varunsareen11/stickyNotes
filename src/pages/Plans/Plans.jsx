...
const Plans = (props) => {
    ...
    function search(items) {
        return items?.filter((item) =>
            Object.values(item).some((val) =>
                String(val).toLowerCase().includes(props.locPlanSearch.toLowerCase())
            )
        );
    }
    ...
    const getDocumentAPI = (data) => {
        return fetch(`${API}/get-plan-data/${selectedLocationId}`, {
            method: "GET",
            headers: {
    ...
    const singleUpdateDocumentAPI = (id, data) => {
        ...
        return fetch(`${API}/update-plan/${id}`, {
            method: "PUT",
            headers: {
                "x-access-token": token,
            },
    ...
    async function deleteDocument(id) {
        let result = await fetch(`${API}/delete-plan/${id}`, {
            method: "DELETE",
            headers: {
                "x-access-token": token,
                Accept: "application/json",
                                                                        ...
                                                                        curElem.category == cateCurelem._id ? (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <div className='btn-group'>
                                                                                    <button className='btn cmn_yellow_bg' onClick={(e) => { singleDocumentAPI(curElem._id); props.setEditPlanCat(true) }}> <svg className="icon" aria-labelledby="Edit Item">
                            ...
                            <DocumentModal
                                content={
                                    <div className='cmn_modal'>
                                        <CloseIcon className="closeModal" color="action" onClick={(e) => { props.setAddPlanDoc(false) }} />
                                        <div className='doc-management-wrap-cate'>
                                            <div className='doc-management-wrap-head'>
                                                <h2 className="dasshboard_heading">Upload New Plan</h2>
                                                <div className='btn-group'>
                                                    ...
                                                    <div className='row'>
                                                        <div className='col-md-6'>
                                                            ...
                                                            <div className='form-group'>
                                                                ...
                                                                <input type="text" className="form-control" name="date" id="date" onChange={(e) => { handleUploadChange(e) }} value={uploadDoc.date} readOnly />
                                                            </div>
                                                            <div className='form-group'>
...

                {
                    props.editPlancat && (
                        <DocumentModal
                            content={
                                <div className='cmn_modal'>
                                    <CloseIcon className="closeModal" color="action" onClick={(e) => { props.setEditPlanCat(false) }} />
                                    <div className='doc-management-wrap-cate'>
                                        <div className='doc-management-wrap-head'>
                                            <h2 className="dasshboard_heading">Edit Plan</h2>
                                            <div className='btn-group'>
                                                <button className='btn cmn_yellow_bg'
