...
function ResetPassword() {
    ...
    async function resetApi() {
        let result = await fetch(`${API}/change-password`, {
            method: "POST",
            headers: {
                        ...
                        <div className='auth-page-form'>
                            <form>
                                <div className='form-group'>
                                    ...
                                    <input type="password" name='password' id='password' className='form-control' placeholder='Passwort' onChange={resetPassHandleInput} value={resetPass.password} />
                                    {error.password && <p className='error'>{error.password}</p>}
                                </div>
                                <div className='form-group'>
                                    <label htmlFor="repeatPassword">Passwort wiederholen</label>
                                    <input type="password" name='repeatPassword' id='repeatPassword' className='form-control' placeholder='Passwort' onChange={resetPassHandleInput} value={resetPass.repeatPassword} />
                                    {error.repeatPassword && <p className='error'>{error.repeatPassword}</p>}
                                </div>
                                <button type="submit" onClick={submitResetform}>Reset Passwort</button>
                            </form>
                        </div>
                    </div>
                </div>
